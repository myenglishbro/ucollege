  ...
  return (
   <>
    ...
    <div class="flex-[1] w-full flex flex-row justify-center flex-wrap md:mt-0 mt-10 gap-8 ">
      ...
      <li class="font-poppins font-normal text-[16px] leading-[24px] text-dimWhite hover:text-secondary cursor-pointer">7:00-08:00 pm 🟢 </li>
      <li class="font-poppins font-normal text-[16px] leading-[24px] text-dimWhite hover:text-terciary cursor-pointer">8:00-09:00 pm 🔴 </li>
