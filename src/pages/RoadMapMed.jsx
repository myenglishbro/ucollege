...
const RoadMapMed = () => {
  ...
  const handleMostrarComponente = () => {
    const validPasswords = ['diegoalvarado','gabrielahilario','alexandermunoz','sherylchacahuasay', 'udemystudent', 'valehuaman', 'patriciaguerron', 'jackelinechaponan','jhoelhuaman'];
