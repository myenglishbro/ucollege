            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-base text-gray-200 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                   con materiales actualizados constantemente. ✨ Explora recursos didácticos diseñados para que mejores tu nivel en cualquier momento y desde cualquier lugar. 🚀📖 ¡Tu aprendizaje nunca se detiene! 🔥
                </p>
              </div>
