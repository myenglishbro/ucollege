...
<div className='row gap-3 mx-3'>
  ...
  <img
            src="https://images.pexels.com/photos/4907457/pexels-photo-4907457.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            alt="Imagen relacionada con el trabajo"
            style={{ width: "100%", height: "auto" }}
          />
    <h2 className='titulos-post'>English for Tourism and Hospitality</h2>
 ...
 <hr></hr>
 <article>
    <h2 className='titulos-post'>UNIT 02  WHAT IS TOURSIM?</h2>
    <iframe title="Quizlet" loading="lazy" src="https://quizlet.com/653795377/match/embed?i=2oqoxh&x=1jj1" height="500" width="100%" style={{ border: "0" }} data-gtm-yt-inspected-4="true"></iframe>
...
export default HospitalityAndTour
