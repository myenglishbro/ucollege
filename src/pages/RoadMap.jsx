...
const RoadMap = () => {
  ...
  const handleMostrarComponente = () => {
    const validPasswords = ['udemystudent', 'andresjaramillo', 'davidbenites', 'jrvchoche', 'cesarhurtado', 'roycondori', 'maxcontreras','rosamamani','manuellopez','teachercarlos','diegosegovia']; 
