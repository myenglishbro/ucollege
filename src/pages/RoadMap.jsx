...
const RoadMap = () => {
  ...
  const handleMostrarComponente = () => {
    const validPasswords = ['celestesalvatierra','diegoalvarado','udemystudent', 'andresjaramillo', 'davidbenites', 'jrvchoche', 'cesarhurtado', 'roycondori', 'maxcontreras','rosamamani','manuellopez','fabrirondon','angelorondon','diegosegovia','shirleyapaza']; 
